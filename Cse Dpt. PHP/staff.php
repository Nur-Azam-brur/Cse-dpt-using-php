...
if (isset($_POST['search'])) {
	...
	$query = "SELECT * FROM staff WHERE Name LIKE '%$searchkey%' OR
	Titulary LIKE '%$searchkey%' OR Email LIKE '%$searchkey%'";
}
else
{
...
<body>
  ...
  <div class="container-fluid">
    ...
    <form class="navbar-form navbar-left" method="post" action="Staff.php">
...
<div class='p_l'>
 ...
 <div class='a_l'> 
  ...
  <div>
    <h1 class="t_one">Office Staff of CSE Department</h1><br><br>
  </div>
